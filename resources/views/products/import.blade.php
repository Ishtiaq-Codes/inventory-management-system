        ...
        <form action="{{ route('products.import.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <x-card>
                <x-slot:header>
                    ...
                    <x-slot:actions>
                        <a href="{{ asset('assets/templates/product_import_template.xlsx') }}" download class="btn btn-outline-success mx-2">
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <div class="text-secondary">
                                    ...
                                    <br><b>A:</b> Name | <b>B:</b> Category | <b>C:</b> Unit | <b>D:</b> Buying Price | <b>E:</b> Selling Price | <b>F:</b> Quantity | <b>G:</b> Alert Quantity | <b>H:</b> Tax %
                                    <br><small><i>If you type a new Category or Unit in the sheet, the system will automatically create it for you!</i></small>
                                </div>
                            </div>
                        </div>
                    </div>
