            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions btn-actions">
                        ...
                        <a href="{{ route('order.downloadInvoice', $order->uuid) }}" target="_blank" class="btn btn-primary d-print-none me-2">
                        ...
                        <form action="{{ route('orders.destroy', $order->uuid) }}" method="POST" class="d-inline-block me-2">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-danger d-print-none" onclick="return confirm('WARNING: Are you sure you want to completely DELETE this order? This will remove it from all business calculations and return the items to stock.')">
