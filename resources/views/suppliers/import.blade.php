    ...
    <div class="container-xl">
        ...
        <form action="{{ route('suppliers.import.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <x-card>
                <x-slot:header>
                    <x-slot:title>
                        {{ __('Import Old Register (Vendors & Debt)') }}
                    </x-slot:title>

                    <x-slot:actions>
                        <a href="{{ asset('assets/templates/supplier_import_template.xlsx') }}" download class="btn btn-outline-success mx-2">
